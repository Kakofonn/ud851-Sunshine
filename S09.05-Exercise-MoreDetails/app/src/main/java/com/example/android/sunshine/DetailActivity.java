...
public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int ID_DETAIL_LOADER = 137;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWeatherHighTemperature = (TextView) findViewById(R.id.high_temperature);
        mWeatherLowTemperature = (TextView) findViewById(R.id.low_temperature);
        ...
        switch (id) {
            case ID_DETAIL_LOADER:
                return new CursorLoader(this,
                        ...
                        null);
            default:
                throw new RuntimeException("Loader by id " + id + " is not implemented");
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        long dateLong = data.getLong(INDEX_WEATHER_DATE);
        String dateText = SunshineDateUtils.getFriendlyDateString(this, dateLong, true);
        ...
        String highTemperatureString = SunshineWeatherUtils.formatTemperature(this, highTemp);
        mWeatherHighTemperature.setText(highTemperatureString);

        double lowTemp = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowTemperatureString = SunshineWeatherUtils.formatTemperature(this, lowTemp);
        mWeatherLowTemperature.setText(lowTemperatureString);
